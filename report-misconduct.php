...
<html lang="en">
    <head>
        <title>
            Westend Hospital | Report misconduct.
        </title>
        ...
        <main>
            ...
            <section id="awardsAndRecognition">
                <div
                    class="container">
                    <!--Report Misconduct-->
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Magni voluptatum voluptas facilis, possimus debitis consectetur labore ipsa suscipit aspernatur porro reprehenderit atque inventore similique ipsum?.</p>
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Magni voluptatum voluptas facilis, possimus debitis consectetur labore ipsa suscipit aspernatur porro reprehenderit atque inventore similique ipsum?.</p>

                    <!--What is misconduct?-->
                    <div class="what-is-misconduct margin-bottom margin-top">
                        <h4 class="sky-blue">What is misconduct ?</h4>
                        <p>
                            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Culpa tempora ducimus recusandae quam. Aut, dolorum.
                        </p>

                        <ul class="square-list-type pad" id="squareList">
                            <li>fraud or illegal practice of a financial nature</li>
                            <li>breaches of patient confidentiality</li>
                            <li>theft by a public officer</li>
                            <li>physical violence, unwanted or inappropriate physical contact including excessive use of force.</li>
                        </ul>
                    </div>

                    <!--How to Report Misconduct-->
                    <div class="how-to-report-misconduct margin-bottom">
                        <h4 class="sky-blue">How to report misconduct</h4>
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit.<a href="#" class="sky-blue">misconduct@thewestendhospital.com</a>
                            Magni voluptatum voluptas facilis, possimus debitis consectetur labore ipsa suscipit aspernatur call our Hotline on
                            <span class="sky-blue">+234 (0) 807 420 2574</span>
                            porro or Hotline  reprehenderit atque inventore similique ipsum?</p>
                    </div>

                    <!--How to report sexual harrassment-->
                    <div class="report-sexual-harassment">
                        <h4 class="sky-blue">How to report Report Sexual Harassment</h4>
                        <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Harum, expedita aut veritatis eligendi praesentium facilis quasi alias, rem explicabo, iure et dolorum magni. Quaerat ab quos, maiores eligendi aspernatur commodi reprehenderit optio esse ex itaque sequi, illum error voluptates recusandae.</p>
                    </div>
                </div>
            </section>
        </main>

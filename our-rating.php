    ...
    <div id="preLoader"></div>
        ...
        <main>
            <div class="section-background-image departments-and-services">
                <div class="container">
                    <h2 class="subnavbar-color">Our Ratings</h2>
                ...
                <div class="container  align-start">
                    <div class="flex">
                        ...
                        <div
                            ...
                            <h3 class="navy-blue text-center" style="margin-bottom: 2em;">Why Our Customer Love's Us ? </h3>
                            <!--Google ratings--->
                            
                            <script src="https://apps.elfsight.com/p/platform.js" defer></script>
                            <div class="elfsight-app-4808b41d-9158-4a6d-87ea-472416528afe"></div>

...
<html lang="en">
    <head>
        <title>
            Westend Hospital | history of westend hospital, warri.
        </title>
        <link rel="icon" type="image/x-icon" href="./img/logo/favicon.ico.png"/>
        <link rel="stylesheet" href="path/to/font-awesome/css/font-awesome.min.css"/>
        <meta name="description" content="Our department includes Radiology, ENT, Occupational health, Laboratory, Pharmacy, Insurance and many more"/>
        <meta charset="UTF-8"/>
                ...
                <div class="container  align-start">
                    <div class="flex">
                        <div class="column-left col-30 v-border-right">
                            <h3 class="text-capitalize navy-blue">About Us</h3>
                            <ul>
                                <li><a href="our-history.html" class="sky-blue">History</a></li>
                                <li><a href="awards-and-recognition.php" class="sky-blue">Awards & Recognition</a></li>
                                <li><a href="our-rating.php" class="sky-blue">Our Ratings</a></li>
                                <li><a href="why-choose-us/our-mission-vision-and-values.php" class="sky-blue">Mission, vision & Values</a></li>
                                <li><a href="#" class="sky-blue">More about the founder</a></li>
                            </ul>
                        </div>
                        ...
                        <div
                            ...
                            <div class="founder">
                                ...
                                <div class="content-wrapper">
                                    <div class="clear-float">
                                        ...
                                        <p>Westend Hospital was founded on January 4th 1978 by Dr J.E.O. Amadasun, Dr .Med., FA (ORL)., FWACS.,FMC (ORL)., FICS., MNES, Lifetime Member; Nigerian Medical Association (NMA).Almost 4 decades later Westend Hospital still remains at the forefront of healthcare delivery in Delta State and Nigeria thanks to our approach of continual improvement.  Westend Hospital still remains at the forefront of healthcare delivery in Delta State and Nigeria thanks to our approach of continual improvement.</p>
                                    </div>
                                    <p>Almost 4 decades later Westend Hospital still remains at the forefront of healthcare delivery in Delta State and Nigeria thanks to our approach of continual improvement.  Westend Hospital still remains at the forefront of healthcare delivery in Delta State and Nigeria thanks to our approach of continual improvement.
                                    </p>
                                    <p>
                                        Westend Hospital is the first private hospital to acquire a CT Scan machine in the defunct Bendel State. Over time we have continued in this kiazen tradition by investing in technology and professional capacity with our recent acquisition of a new GE CT Scannthe setup of a Stroke Unit managed by our own in-house Consultant Neurologist.Westend Hospital is the first private hospital to acquire a CT Scan
                                    </p>
                                    <p>

                                        n technology and professional capacity with our recent acquisition of a new GE CT Scanner and the setup of a Stroke Unit managed by our own in-house Consultant Neurologist.</p>
                                    <p>
                                ...
                                <p>The name “Westend” came from the fact that we wanted our hospital to be seen as representing the “western end” of orthodox medicine or rather, the level of medical practice experienced in Western Europe. orthodox medicine or rather, the level of medical practice experienced in Western Europe</p>
                            </div>

                            <!--photo gallery of various sections of westend hospital-->
                            <div class="photo-gallery">
                                <h3 class="sky-blue text-center">Photo Gallery</h3>
                                <div class="flex">
                                    <div class="photo-gallery-img">
                                        <img src="./img/photo-gallery-of-westend-hospital/pexels-karolina-grabowska-8539447.jpg" alt="photo1">
                                    ...
                                    <div class="photo-gallery-img">
                                        <img src="./img/photo-gallery-of-westend-hospital/pexels-mart-production-7089622.jpg" alt="photo1">
                                        <div class="overlay-content">
                                            <h4>CT Scan Unit</h4>
                                            <p>Lorem, ipsum dolor.Lorem, ipsum dolor, </p>                                        </div>
                                    </div>
                                    <div class="photo-gallery-img">
                                        <img src="./img/photo-gallery-of-westend-hospital/pexels-mart-production-7089031.jpg" alt="photo1">
                                        <div class="overlay-content">
                                            <h4>4D Ultrasound Machine</h4>
                                            <p>Lorem, ipsum dolor.Lorem, ipsum dolor, </p>
                                        </div>
                                    </div>
                                    <div class="photo-gallery-img">
                                        <img src="./img/photo-gallery-of-westend-hospital/pexels-mart-production-7089392.jpg" alt="photo1">
                                        <div class="overlay-content">
                                            <h4>32 Slice MRI Machine</h4>
                                            <p>Lorem, ipsum dolor.</p>
                                        </div>
                                    </div>
                                    <div class="photo-gallery-img">
                                        <img src="./img/photo-gallery-of-westend-hospital/pexels-mart-production-7089035.jpg" alt="photo1" style="width: 100%;">
                                        <div class="overlay-content">
                                            <h4>2D Ultrasound Machine</h4>
                                            <p>Lorem, ipsum dolor.</p>
                                        </div>
                                    </div>
                                    <div class="photo-gallery-img">
                                        <img src="./img/photo-gallery-of-westend-hospital/pexels-mart-production-7088530.jpg" alt="photo1">
                                        <div class="overlay-content">
                                            <h4>CT Console Room</h4>
                                            <p>Lorem, ipsum dolor.</p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Atque blanditiis eveniet vel, similique tempora tenetur pariatur, sunt repellendus odio provident ipsum adipisci numquam amet incidunt delectus, soluta laudantium eligendi facere.</p>

                            <!--Early Expansion of the hospital-->
                            <div class="early-expansion">
                                <h3 class="navy-blue">Early Expansion of the Hospital</h3>
                                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Vel enim quaerat beatae libero necessitatibus. Reiciendis harum totam earum dolore maxime ullam quae esse, saepe ducimus perferendis nulla amet placeat eveniet.</p>
                                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Vel enim quaerat beatae libero necessitatibus. Reiciendis harum totam earum dolore maxime ullam quae esse, saepe ducimus perferendis nulla amet placeat eveniet.</p>
                            </div>
                            <!--Timeline Event -->
                                    ...
                                    <div class="timeline">
                                        ...
                                        <div class="timecontainer right">
                                            <div class="timelineboxcontent flex">                                               
                                                <h4 class="navy-blue absolute-left" data-aos="fade-right" data-aos-duration="500" data-aos-easing="ease-in-sine">1</h4>                    
                                                <div class="flex-year-info" data-aos="fade-up"
                                                data-aos-anchor-placement="top-bottom" data-aos-duration="3000">          
                                            <div class="year-rounded ">
                                                <h5 class=" cicle-left text-white cycles bg-navy-blue">1978</h5>
                                            </div>
                                                <div class="info-text-container flex-column">
                                                    <h5 class="navy-blue">Westend Hospital was founded</h5>
                                                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elitconsectetur adipisicing </p>
                                                </div>
                                            </div>
                                        </div>
                                        </div>
                                        ...
                                        <div class="timecontainer left">
                                            <div class="timelineboxcontent flex">                                               
                                                <h4 class="sky-blue absolute-right"data-aos="fade-left" data-aos-duration="500" data-aos-easing="ease-in-sine">2</h4>  
                                                
                                                <div class="flex-year-info" data-aos="fade-up"
                                                data-aos-anchor-placement="top-bottom" data-aos-duration="3000">   
                                            <div class="year-rounded float-right">
                                                <h5 class="cicle-right text-white  text-align-right cycles bg-sky-blue">1990</h5>
                                            </div>

                                                <div class="info-text-container flex-column">
                                                    <h5 class="sky-blue">Expansion of the Hospital</h5>
                                                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elitconsectetur adipisicing </p>
                                                </div>
                                            </div>
                                            </div>
                                          ...
                                          <div class="timecontainer right">
                                            <div class="timelineboxcontent flex">                                               
                                                <h4 class="crown-royal absolute-left"  data-aos="fade-right" data-aos-duration="500" data-aos-easing="ease-in-sine">3</h4>    
                                                <div class="flex-year-info" data-aos="fade-up"
                                                data-aos-anchor-placement="top-bottom" data-aos-duration="3000">                                 
                                            <div class="year-rounded ">
                                                <h5 class=" cicle-left text-white cycles bg-crown-royal">2000</h5>
                                            </div>
                                                <div class="info-text-container flex-column">
                                                    <h5 class="crown-royal">Westend Hospital was founded</h5>
                                                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elitconsectetur adipisicing </p>
                                                </div>
                                            </div>       
                                            </div>
                                         ...
                                         <div class="timecontainer left">
                                            <div class="timelineboxcontent flex">                                               
                                                <h4 class="important-text absolute-right" data-aos="fade-left" data-aos-duration="500" data-aos-easing="ease-in-sine">4</h4>  
                                                
                                                <div class="flex-year-info" data-aos="fade-up"
                                                data-aos-anchor-placement="top-bottom" data-aos-duration="3000">   
                                            <div class="year-rounded float-right">
                                                <h5 class="cicle-right text-white  text-align-right cycles bg-importent-text">2005</h5>
                                            </div>

                                                <div class="info-text-container flex-column">
                                                    <h5 class="important-text">Expansion of the Hospital</h5>
                                                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elitconsectetur adipisicing </p>
                                                </div>
                                            </div>
                                            </div>
                                          ...
                                          <div class="timecontainer right">
                                            <div class="timelineboxcontent flex">                                               
                                                <h4 class="header-link-color absolute-left" data-aos="fade-right" data-aos-duration="500" data-aos-easing="ease-in-sine">5</h4>    
                                                <div class="flex-year-info" data-aos="fade-up"
                                                data-aos-anchor-placement="top-bottom" data-aos-duration="3000">                                 
                                            <div class="year-rounded ">
                                                <h5 class=" cicle-left text-white cycles bg-header-link-color">2010</h5>
                                            </div>
                                                <div class="info-text-container flex-column">
                                                    <h5 class="header-link-color">Westend Hospital was founded</h5>
                                                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elitconsectetur adipisicing </p>
                                                </div>
                                            </div>       
                                            </div>

...
<html lang="en">
    <head>
        <title>
            Westend Hospital | Patient feedback.
        </title>
        ...
        <main>
            ...
            <section id="patientFeedback">
                <div
                    class="container">
                    <!--Patient feedback-->
                    <p>Johns Hopkins is committed to providing you and your loved ones a respectful and positive experience. Our staff are here to listen and help address any concerns you may have. Our goal is to ensure you and your family receive safe, high quality and compassionate care and service.</p>
                    <p>Johns Hopkins is committed to providing you and your loved ones a respectful and positive experience. Our staff are here to listen and help address any concerns you may have. Our goal is to ensure you and your family receive safe, high quality and compassionate care and service.</p>

                    <!--Your experience matters to us-->
                    <div class="your-experience-matters margin-top margin-bottom">
                        <h4 class="sky-blue">Your Experience Matters to Us</h4>
                        <p>
                        ...
                        <p>
                            Our patient relations assistants can help facilitate a formal review and follow-up to your concerns. Information shared with Patient Relations is reported to all executive levels of the hospital.</p>


                    </div>

                    <!--tell us about your experience-->
                    <div class="tell-us-about-your-experience margin-bottom">
                        <h4 class="sky-blue">Tell Us About Your Experience</h4>
                        <p>Our patient relations assistants can help facilitate a formal review and follow-up to your concerns. Information shared with Patient Relations is reported to all executive levels of the hospital. We appreciate all feedback, good or bad.</p>
                        <p>The Office of Patient Experience at Johns Hopkins Bayview Medical Center is here to help you navigate medical encounters and to provide an opportunity for you or your family members to report specific concerns.</p>
                    </div>

                    <!--How to report sexual harrassment-->
                    <div
                        class="report-sexual-harassment">
                        <!--westendhospital-info container-->
                        <div class="info-container-westend-hospital"></div>
                        <div class="phone flex col-50">
                            <h5 class="sky-blue">Phone:</h5>
                            <p class="box-info">+234 (0) 807 420 2574</p>
                        </div>
                        <div class="email flex col-50">
                            <h5 class="sky-blue">Email:</h5>
                            <a href="mailto:patientexperience@thewestendhospital.com" class="box-info sky-blue">patientexperience@thewestendhospital.com</a>
                        </div>
                        <div class="mail flex col-50">
                            <h5 class="sky-blue">Mail:</h5>
                            <div class="box-info">
                                <p>
                        ...
                        <div class="in-person flex col-50">
                            <h5 class="sky-blue">In-person:</h5>
                            <div class="box-info">
                                <p>Patients and family members can call to schedule an appointment to visit our office and speak with a patient experience coordinator Monday through Friday, 8:30 a.m. to 5 p.m.</p>

            ...
            <section id="accepted-insurance">
                <div
                    ...
                    <div class="margin-bottom">
                        <h3 class="navy-blue">Westend Hospital accepts most health insurance plans, including RedCare and Hygeia.</h3>

                        <p>If you are covered by health insurance, you are strongly encouraged to consult with your health insurer to determine accurate information about your financial responsibility for a particular health care service. Before scheduling your hospital visit, check with your health insurance provider to see if you are covered and learn the specifics of your coverage.about your financial responsibility for a particular health care service. Before scheduling your hospital visit, check with your health insurance provider to see if you are covered and learn the specifics of your coverage.</p>

                        <p>If you are covered by health insurance, you are strongly encouraged to consult with your health insurer to determine accurate information about your financial responsibility for a particular health care service.</p>

                        <p>Your health insurance provider will be able to inform you of your level of coverage and what, if any, copayments, coinsurances and deductibles will be your responsibility. If you do not contact your provider, you can be ultimately be responsible for all or a large portion of your bill.</p>
                        <a href="./accepted-insurance/list-of-accepted-insurance.php" class="sky-blue">List of all health Insurance accepted by Westend Hospital</a>
                    </div>
                    <!--manage care and prior approvals-->
                    <div class="margin-bottom">
                        <h3 class="navy-blue">Managed Care and Prior Approvals</h3>
                        <p>If you are enrolled in a managed care group, such as an HMO or PPO, you might need a referral from your primary care physician. Please contact your physician for authorization before your appointment, elective procedure or admission to the hospital. Depending on your insurance provider, you might be required to pay a deductible or copayment.</p>
                    </div>
                    <!-- emergency care-->
                    <div class="margin-bottom">
                        <h3 class="navy-blue">Emergency Care</h3>

                        <p>If you are admitted to the Emergency Department and belong to a managed care group, such as an HMO or PPO, you must notify your primary care doctor and insurer as soon as possible. If you fail to do this, your insurer might not agree to pay your entire bill. Westend Hospital will make every effort to notify your insurer that you are in the hospital, but this is ultimately your responsibility</p>
                    </div>
                    <!-- second opinions-->
                    <div>
                        <h3 class="navy-blue">Second Opinions</h3>
                        <p>Before scheduling a second-opinion consultation at Westend Hospital, be certain to discuss second-opinion requirements with your insurance company, who can tell you if precertification is required..</p>
                    </div>
                </div>
            </section>
        </main>

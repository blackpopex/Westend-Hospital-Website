...
<html lang="en">
    <head>
        <title>
            Westend Hospital | Request an appointment with us
        </title>
    ...
    <div id="preLoader"></div>
        ...
        <!---------------------------MAIN PAGE CONTENT---------------------------------------------->
        <main>
            <div class="section-background-image request-an-appointment" id="requestAppointment">
                <div class="container">
                    ...
                    <div
                        ...
                        <div class="form-container col-70">
                            <div>
                                ...
                                <p>
                                    To speak with someone regarding making an appointment or help                                                                                                                                        figuring out if Westend Hospital treats a specific condition,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      please call the Westend Hospital frontdesk at
                                    <span class="sky-blue">+234 (0) 807 420 2574</span>
                                    or request an appointment by filling the form below and we

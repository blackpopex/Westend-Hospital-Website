...
<html lang="en">
  <head>
    <title>
      Westend Hospital | Map and Direction to westend Hospital Warri
    </title>
    ...
    <meta
      name="description"
      content="Westend Hospital is located at 1,25th street, D.D.P.A., Housing Estate, Warri, Delta State."
    />
    <meta charset="UTF-8" />
  ...
  <div id="preLoader"></div>
    ...
    <main>
      ...
      <section id="map-direction">
        <div class="container">
          <div class="flex">
            <div class="weh-img-container col-30">
              <img
                src="img/other photos/westehnd-hospital-cross-section.jpg"
                alt="Westend Hospital"
              />
              <div>
                <h4 class="navy-blue text-center">Westend Hospital Warri</h4>
                <p>
                  1, 25th Street, D.D.P.A, Housing Estate Warri, Delta State,
                  Nigeria.
                </p>
                <p id="textCenter" class="sky-blue">
                  <i class="fa fa-phone-alt"></i>
                  <span> +234 (0) 807 420 2574 </span>
                </p>
                <a
                  class="sky-blue"
                  target="_blank"
                  ...
                  ><i class="fa fa-street-view text-center"></i>
                  <span>Get Directions</span></a
                >
              </div>
            </div>
            <div class="map-container col-70">
            <img
                width="800"
                src="https://www.mapquestapi.com/staticmap/v4/getplacemap?key=i100WkQHKug4s1SW4ItjpQpiXbdLd0o1&location=5.54614071809166, 5.761091047792277&size=800,400&type=map&zoom=12&imagetype=jpeg&scalebar=false&showicon=red_1-1"
                alt="MapQuest Map of 5.54614071809166, 5.761091047792277"
                id="yandexMap"
              />
            </div>
          </div>

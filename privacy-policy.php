...
<html lang="en">
    <head>
        <title>
            Westend Hospital | Privacy Policy.
        </title>
        <link rel="icon" type="image/x-icon" href="img/logo/favicon.ico.png"/>
        <link rel="stylesheet" href="path/to/font-awesome/css/font-awesome.min.css"/>
        <meta name="description" content="Our mission is to continue to change to better serve our patients while we uphold our integrity, Our Vision is to attain a level of high functionality and an environment that would encourage the partnering of discerning minds strategically aligned with our goals and committed to deliver the best health care service in Nigeria. "/>
        <meta charset="UTF-8"/>
        ...
        <main>
            ...
            <section id="privacyPolicy">
                <div
                    ...
                    <!--Privacy policy-->
                    <p>Westend Hospital is committed to protecting the privacy of visitors to our website, this statement to demonstrate our commitment to on-line privacy. It discloses our information-gathering and dissemination practices for this website. .</p>
                    <p>You may visit our website without submitting any information about yourself. If you send us e-mail or subscribe to one of our on-line publications, you will be asked to submit information about yourself. We will use this information for replying to your message or forwarding the requested material. We do not share this information with any other partners, .</p>
                    <p>However, due to the nature of electronic communications, we cannot and do not provide any assurances that the contents of your e-mail will not become known or accessible to third parties. WE URGE YOU NOT TO PROVIDE ANY CONFIDENTIAL INFORMATION ABOUT YOU OR YOUR HEALTH TO US VIA ELECTRONIC COMMUNICATION. If you do so, it is at your own risk.</p>
                    <div class="margin-top margin-bottom">
                        <h4 class="sky-blue">Information Which We Collect</h4>
                        <p>When you use our website, our technologies may collect & store information that is generated automatically - such as your IP address. This is common among many internet services to enable the investigation of issues such as the identification of malicious use.</p>
                        <p>Union Hospital does not sell, trade or rent personal information to third-parties. We only share information with other organizations where it is necessary & the law permits - such as our authorized data processors for the purpose of processing the data in connection with the procured service.</p>
                    </div>
                    <div class="margin-bottom">
                        <h4 class="sky-blue">Cookies</h4>
                        <p>"Cookies" are small pieces of information that we can store on your web browser on your computer's hard drive. Cookies allow us to enhance the overall experience while on our Website. Cookies information is used in the aggregate to understand how visitors are interacting with the Website.
                                                                                    You may choose to set your web browser to refuse cookies or to alert you when cookies are being sent.</p>
                    </div>
                    <div class="margin-bottom">
                        <h4 class="sky-blue">How We Safeguard Your Information</h4>
                        <p>At Union Hospital, we understand how important the security and confidentiality of your information is to you. Keeping customer information secure is very important for Union Hospital. All personal information collected at this Website is kept strictly confidential and is only used for the purposes specified at the time of collection.</p>
                        <p>We invest significantly to protect your data from loss, misuse, unauthorized access, modification or disclosure. However, no internet-based site is 100% secure, and so we cannot be held responsible for unauthorized access that is beyond our control.</p>

                    </div>
                    <div>
                        <h4 class="sky-blue">Consent</h4>
                        <p>By using this Website, you consent to the collection and use of the information discussed above by Union Hospital.</p>
                    </div>
                </div>
            </section>
        </main>

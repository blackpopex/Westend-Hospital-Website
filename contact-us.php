...
<html lang="en">
    <head>
        <title>Westend Hospital | Contact us for all you medical needs</title>
        <link rel="icon" type="image/x-icon" href="./img/logo/favicon.ico.png"/>
        <link rel="stylesheet" href="path/to/font-awesome/css/font-awesome.min.css"/>
        <meta name="description" content="At Westend Hospital we have competent and professional doctors who are skilled in various specialties including dermatology, gynaecology, urogrology, nephrology, neurologist e.t.c. . "/>
        <meta charset="UTF-8"/>
            ...
            <section id="contact-us">
                <div class="container">
                    <div class="wrapper form-container">
                        <h3 class="navy-blue">
                            Phone Directories for Westend Hospital Warri
                        </h3>
                        <div>
                            <h4 class="sky-blue">Important Phone Numbers</h4>
                            <table>
                                <tr>
                            ...
                            <p class="text-center">
                                For feedback regarding your experience with Westend Hospital,
                                                                                please visit
                                <a href="feedback.html" class="sky-blue">feedback</a>.
                            </p>
                            ...
                            <form action="action_page.php" method="post" autocomplete="off">
                                <div class="form-content">
                                    ...
                                    <h4 class="navy-blue">Your Contact Information</h4>
                                    ...
                                    <div class="flex">
                                        ...
                                        <div class="col-50">
                                            <label for="question">Type of question:
                                            </label>
                                    ...
                                    <div class="col-100">
                                        <label for="your-question">Your question:<span>*</span>
                                        </label>
                                        <textarea name="yourQuestion" id="your-question" col="10" rows="4" required></textarea>
                                    </div>

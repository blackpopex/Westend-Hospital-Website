                    ...
                    <div class="flex">
                        ...
                        <div class="column-right col-70">
                            <div>
                              ...
                              <p>Find out what it is really like to work at Westend Hospitals from those who know best – our staff. The profiles below will give you an insight into what life is like working in one of Nigeria’s best hospitals. </p>
                              ...
                              <div class="profile article-box col-30">
                                    ...
                                    <div class="article-content lighter-blue-bg">
                                        ...
                                        <a href="../../why-choose-us/management-team/greg-kelly.php" class="skyblue float-right">Read More <i class="fa fa-angle-right"></i></a>
                                    </div>
                              </div>
                                    <!--Dr. Micheal-->
                              <div class="profile article-box col-30">
                                    ...
                                    <div class="article-content lighter-blue-bg">
                                        <p>Consultant Clinical Psychologist, Chronic Pain Service</p>
                                        <a href="#" class="skyblue float-right">Read More <i class="fa fa-angle-right"></i></a>
                                    </div>
                              </div>
                                   <!--Dr. Amaka-->
                              <div class="profile article-box col-30">

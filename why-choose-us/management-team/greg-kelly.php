...
<html lang="en">
    <head>
        <title>
            Westend Hospital | Meet our team of workers.
        </title>
        <link rel="icon" type="image/x-icon" href="../../img/logo/favicon.ico.png"/>
        <link rel="stylesheet" href="path/to/font-awesome/css/font-awesome.min.css"/>
        <meta name="description" content="Our uniqueness begins with our team, we work as one so that we can achieve a common goal. "/>
        <meta charset="UTF-8"/>
        ...
        <main>
            <div class="section-background-image staff-profile">
                <div class="container flex profile-header">
                    <img src="../../img/team-members/medical team/usman-yousaf-pTrhfmj2jDA-unsplash.jpg" alt="Usman Yousaf" id="staffImg">
                    <div class="staff-profile-details">
                    <h2 class="subnavbar-color">Dr. Grey Kelly</h2>
                    <h4 class="navy-blue">Consultant paediatric and fetal cardiologist</h4>
                    <p>Dr Grey Kelly is a consultant paediatric and fetal cardiologist based at University Teaching Hospital, Benin City (UBTH)</p>
                    <ul class="inline-block-breadcrumb subnavbar-color">
                        ...
                        <li>
                            <a href="../../why-choose-us/management-team/management-team.php">management-team</a>
                        </li>                          
                        <li>grey-kelly</li>
                    </ul>
                </div>
                ...
                <div
                    ...
                    <div class="flex">
                        ...
                        <div class="column-left col-30">
                            <h3 class="navy-blue">Profile Details</h3>
                            <div class="margin-bottom">
                            <h4 class="sky-blue">Specialty</h4>
                            <ul>
                                <li>Paediatrics</li>
                            ...
                            <div class="margin-bottom">
                            <h4 class="sky-blue">Spoken Languages</h4>
                            <ul>
                                <li>English</li>
                            </ul>
                        </div>
                            <div>
                            <h4 class="sky-blue">Memberships</h4>
                            <ul>
                        ...
                        <div class="column-right col-70">
                            ...
                            <div class="margin-bottom"> 
                              ...
                              <p>Dr Beverly Tsai-Goodman studied medicine at the University of  Southampton.  In 2004 she was awarded a doctorate from the University of Bristol where she trained in paediatric cardiology and practised as a consultant until 2016. Additionally, from 2004 to 2014, Dr Tsai-Goodman was the leading cardiologist for the Barth Syndrome Specialist Services in Bristol.</p>
                              <p>She also spent 15 months at Boston’s Children’s Hospital and Harvard Medical School as a senior clinical fellow. During this time, she trained in cardiac MRI, echocardiography and fetal cardiology.</p>
                              <p>Since 2017 Dr Tsai-Goodman has been a consultant paediatric and fetal cardiologist at Royal Brompton Hospital.</p>
                              <p>She she was recently awarded a master’s (MSc) degree in genomics medicine at Imperial College London. Her aim is to combine her expertise in paediatric and fetal cardiology with the latest in human genomics.</p>                    
                            </div>
                            <!--Clinical Expertise-->
                            <div>
                                <h3 class="navy-blue">Clinical Expertise</h3>
                              <p>Dr Beverly Tsai-Goodman studied medicine at the University of  Southampton.  In 2004 she was awarded a doctorate from the University of Bristol where she trained in paediatric cardiology and practised as a consultant until 2016. Additionally, from 2004 to 2014, Dr Tsai-Goodman was the leading cardiologist for the Barth Syndrome Specialist Services in Bristol.</p>
                              <p>She also spent 15 months at Boston’s Children’s Hospital and Harvard Medical School as a senior clinical fellow. During this time, she trained in cardiac MRI, echocardiography and fetal cardiology.</p>
                              <p>Since 2017 Dr Tsai-Goodman has been a consultant paediatric and fetal cardiologist at Royal Brompton Hospital.</p>
                              <p>She she was recently awarded a master’s (MSc) degree in genomics medicine at Imperial College London. Her aim is to combine her expertise in paediatric and fetal cardiology with the latest in human genomics.</p>                    

                ...
                <div class="container align-start">
                    <div
                        ...
                        <div class="column-left col-30 v-border-right">
                            <h3 class="navy-blue">Team by category</h3>
                            <ul>
                                <li><a href="management-team/management-team.php">Management Team</a></li>
                                <li><a href="#">Medical Team</a></li>
                                <li><a href="#">Security Team</a></li>
                                <li><a href="#">Adminstrative Team</a></li>
                                <li><a href="#">Receptionist Team</a></li>
                            </ul>
                        </div>
                        <!--staff profile-->
                        <div class="column-right col-70">
                            <div>
                                <h3 class="navy-blue">Staff profiles</h3>
                                <p>Find out what it is really like to work at Westend Hospitals from those who know best – our staff. The profiles below will give you an insight into what life is like working in one of Nigeria’s best hospitals.
                                </p>

                                <div class="article-container flex">
                                    <!--set each box to 30%-->
                                    <!--Dr. Felix-->
                                        <div class="profile article-box col-30"> <img src="../img/team-members/medical team/usman-yousaf-pTrhfmj2jDA-unsplash.jpg" alt="Grey Kelly">
                                        <div class="title transparent-sky-blue">
                                            <h4>Grey Kelly</h4>
                                        </div>
                                        <div class="article-content lighter-blue-bg">
                                            <p>Consultant Clinical Psychologist, Chronic Pain Service</p>
                                            <a href="./management-team/greg-kelly.php" class="sky-blue float-right">Read More
                                    ...
                                    <div class="profile article-box col-30">
                                        <img src="../img/team-members/medical team/usman-yousaf-4fo0gcw76so-unsplash.jpg" alt="Claire Copland">
                                        <div class="title transparent-navy-blue">
                                            <h4>Claire Copland</h4>
                                        </div>
                                        <div class="article-content lighter-blue-bg">
                                            <p>Consultant Clinical Psychologist, Chronic Pain Service</p>
                                            <a href="#" class="sky-blue float-right">Read More
                                                <i class="fa fa-angle-right"></i>
                                            </a>
                                        </div>
                                    </div>
                                    <!--Dr. Amaka-->
                                    <div class="profile article-box col-30">
                                        <img src="../img/team-members/medical team/usman-yousaf-pTrhfmj2jDA-unsplash.jpg" alt="Grey Kelly">
                                        <div class="title transparent-sky-blue">
                                            <h4>Grey Kelly</h4>
                                        </div>
                                        <div class="article-content lighter-blue-bg">

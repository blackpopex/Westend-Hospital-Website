...
<html lang="en">
    <head>
        <title>
            Westend Hospital | Our mission, vision and values.
        </title>
        ...
        <main>
            ...
            <section id="mission-vision-values">
                <div
                    ...
                    <p>Mission, vision, and values statements allow healthcare organizations to determine what, exactly, they aim to accomplish and how they can provide the standard of care their patients deserve.</p>
                    <p>At Westend Hospital our key statements convey the reasons we exist as an organization, what we aspire to as an organization and the way we will work to get there. They are a unifying force that link all of us together.</p>
                    <div class="margin-bottom margin-top">
                        <h4 class="sky-blue">Our mission</h4>
                        <p>Our mission is to continue to change to better serve our patients while we uphold our integrity.</p>
                    </div>
                    <div class="margin-bottom">
                        <h4 class="sky-blue">Our vision</h4>
                        <p>Our Vision is to attain a level of high functionality and an environment that would encourage the partnering of discerning minds strategically aligned with our goals and committed to deliver the best health care service in Nigeria.</p>
                    </div>
                    <div class="margin-bottom"> 
                        <h4 class="sky-blue">Our core values</h4>
                        <p>In the pursuit of this vision, the actions of leadership, staff and other physicians will be guided by the following values:</p>
            ...
            <section id="our-strategic-plan">
                <div class="container">
                    ...
                    <div class="text-center">
                        ...
                        <h4 class="sky-blue text-center">To Achieve Our Mission</h4>
                    </div>

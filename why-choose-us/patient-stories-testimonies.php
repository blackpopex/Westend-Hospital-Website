...
<html lang="en">
    <head>
        <title>
            Westend Hospital | Patient Stories and Testimonies
        </title>
    ...
    <body>
        ...
        <main>
            ...
            <section id="patient-stories">
                <div class="container">
                    <p>We can tell you all about our core values of caring for people with compassion, excellence and teamwork. But nobody can tell it better than our patients. Here are just a few stories from our patients. In these stories you'll see a glimpse of what Westend Hospital is all about.</p>
                    <p>Do you have a story to share ? visit
                        <a href="info@thewestendhospital.com" class="sky-blue">info@thewestendhospital.com</a>.</p>
                    <!--patient stories-->
                    <div class="col-100">
                        <div>
                            <div class="article-container flex">
                                ...
                                <!--Myria Mack-Williams story-->
                                    <div class="profile article-box col-30"> <img src="../img/testimonials/andriyko-podilnyk-yhk_zsfgw0g-unsplash.jpg" alt="Grey Kelly">
                                    <div class="title transparent-sky-blue">
                                        <h4>Padiatrics</h4>
                                    </div>
                                    <div class="story article-content lighter-blue-bg">
                                        <p>Myria Mack-Williams, M.D., is more than just a pediatrician. See what makes her practice different.</p>
                                        <a href="./management-team/greg-kelly.php" class="sky-blue float-right">Read story
                                ...
                                <div class="profile article-box col-30">
                                    <img src="../img/testimonials/edward-cisneros-_H6wpor9mjs-unsplash.jpg" alt="Grey Kelly">
                                    <div class="title transparent-navy-blue">
                                        <h4>Pregnancy</h4>
                                    </div>
                                    <div class="story article-content lighter-blue-bg">
                                        <p>Myria Mack-Williams, M.D., is more than just a pediatrician. See what makes her practice different.</p>
                                        <a href="#" class="sky-blue float-right">Read story
                                            <i class="fa fa-angle-right"></i>
                                        </a>
                                    </div>
                                </div>
                                ...
                                <!--Myria Mack-Williams story-->
                                <div class="profile article-box col-30">
                                    <img src="../img/testimonials/daniel-capelani-gRslJX1S4h0-unsplash.jpg" alt="Grey Kelly">
                                    <div class="title transparent-sky-blue">
                                        <h4>Trauma</h4>
                                    </div>
                                    <div class="story article-content lighter-blue-bg">
                                ...
                                <!--Myria Mack-Williams story-->
                                <div class="profile article-box col-30">
                                    <img src="../img/testimonials/freddy-kearney-o-ioeoATbIM-unsplash(1).jpg" alt="Grey Kelly">
                                    <div class="title transparent-navy-blue">
                                        <h4>Stroke Care</h4>
                                    </div>
                                    <div class="story article-content lighter-blue-bg">

        ...
        <main>
            ...
            <section id="TermsOfUse">
                <div class="container">
                    ...
                    <p>Your access and use of this site and any page contained herein beginning with www.hospitals.jefferson.edu is subject to the following terms of use and all applicable laws. By viewing Web pages in this site, you accept, without limitation or qualification, these terms.
                    </p>


                    <div class="margin-top margin-bottom">
                        <h4 class="sky-blue">Copyright</h4>
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ab minus voluptatum distinctio repudiandae inventore quaerat odio quisquam quo, obcaecati enim temporibus quidem. Corporis nulla quas et placeat hic quam facere ipsam iusto rem, necessitatibus deserunt esse a dolorum saepe architecto. Iusto modi, sapiente cumque quos soluta voluptatibus totam fugiat eius?</p>
                    </div>
                    <div class="margin-bottom">
                        <h4 class="sky-blue">Links.</h4>
                        <p>You may not establish a link to this site without the express written consent of the General Counsel of TJUH. Please note that this site is linked to other sites which may have different terms of use. Please refer to those sites for the appropriate information.
                        </p>
                    </div>
                    <div class="margin-bottom">
                        <h4 class="sky-blue">Accuracy</h4>
                        <p>The information provided in this Web site is for informational purposes only. It is not a substitute for medical advice. All medical information presented should be discussed with your healthcare professional. Remember, the failure to seek timely medical advice can have serious ramifications. We urge you to discuss any current health related problems you are experiencing with a healthcare professional immediately.</p>

                    </div>
                    <div class="margin-bottom">
                        <h4 class="sky-blue">Specific Disclaimer Concerning Medical Information</h4>
                        <p>By using this Website, you consent to the collection and use of the information discussed above by Union Hospital.</p>
                    </div>
                    <div>
                        <h4 class="sky-blue">Trademarks.</h4>
                        <p>All trademarks, service marks, and logos ("Trademarks") displayed and used in this site are the property of their respective owners. Nothing in this site should be construed as granting any right or license to use any Trademark without the written permission of its owner.
                        </p>
                    </div>
                </div>
            </section>

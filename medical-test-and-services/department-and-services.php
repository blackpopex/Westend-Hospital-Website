...
<html lang="en">
    <head>
        <title>
            Westend Hospital | We have various departments and each department offers unique services.
        </title>
                ...
                <div class="container  align-start">
                    <div class="flex">
                        <div class="column-left col-30 v-border-right">
                            <h3 class="text-capitalize navy-blue">Departments & Services</h3>
                            <a href="A-Z-of-all-medical-services.php" class="sky-blue">A-Z of all Services</a>
                        </div>
                        <!--Clincal Departments-->
                        <div class="column-right col-70">
                            <div class="margin-bottom">
                                ...
                                <div class="flex department-services">
                                    <ul>
                                        <li>
                                            <a href="#">Anesthesiology & Perioperative</a>
                                        </li>
                                        <li>
                                    ...
                                    <ul>
                                        <li><a href="#">Patient and Family Relations</a></li>
                            ...
                            <div class="margin-top">
                                ...
                                <div class="flex department-services">
                                    <ul>
                                        <li>
                                            <a href="#">Care Coordination</a>
                                        </li>
                                        <li>
                                            <a href="#">Orthopaedic Surgery</a>
                                        </li>
                                        <li>
                                            <a href="#">Virtual Visit Setup</a>
                                        </li>
                                        <li>
                                            <a href="#">Nutrition</a>
                                        </li>
